...
namespace deadcode.DeepSearch
{
    ...
    //     - An empty deepsearch file in the same directory as NewFileItems.vsdir. In
    //       our case we chose DeepSearch.deepsearch. Note this file name appears in Editor.vsdir
    ...
    //          - "DeepSearch" - This is the base file name. New files will initially
    //             be named as DeepSearch1.deepsearch, DeepSearch2.deepsearch... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    DeepSearch.deepsearch|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - DeepSearch.deepsearch - our empty deepsearch file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".deepsearch";
        ...
        #region Fields
        private DeepSearchPackage myPackage;
        ...
        public EditorPane(DeepSearchPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the deepsearch document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(DeepSearchPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidDeepSearchCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidDeepSearchCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidDeepSearchEditorFactory;
            return VSConstants.S_OK;
        }
