...
using deadcode.DeepSearch;

namespace DeepSearch_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new DeepSearchPackage() as IVsPackage;
            ...
            BaseMock registerEditor = DeepSearch_UnitTests.EditorTests.RegisterEditorsServiceMock.GetRegisterEditorsInstance();
            serviceProvider.AddService(typeof(SVsRegisterEditors), registerEditor, false);
            
            // Site the package
            Assert.AreEqual(0, package.SetSite(serviceProvider), "SetSite did not return S_OK");

            MethodInfo method = typeof(DeepSearchPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
