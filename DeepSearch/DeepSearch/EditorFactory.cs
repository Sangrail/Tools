...
namespace deadcode.DeepSearch
{
    ...
    /// </summary>
    [Guid(GuidList.guidDeepSearchEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private DeepSearchPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(DeepSearchPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidDeepSearchEditorFactory;
            pgrfCDW = 0;
