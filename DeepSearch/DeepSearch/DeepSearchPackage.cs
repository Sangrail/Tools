...
namespace deadcode.DeepSearch
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".deepsearch", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "DeepSearch")]
    [ProvideKeyBindingTable(GuidList.guidDeepSearchEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidDeepSearchPkgString)]
    public sealed class DeepSearchPackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidDeepSearchCmdSet, (int)PkgCmdIDList.cmdidDeepSearch);
